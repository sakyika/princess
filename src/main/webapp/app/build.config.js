...
module.exports = {
   ...
   */
  app_files: {
    js: [ 'src/**/*.js', '!src/**/*.spec.js', '!src/**/*.scenario.js', '!src/**/*.e2e.js', '!src/assets/**/*.js', '!src/**/*.page.js' ],
    jsunit: [ 'src/**/*.spec.js', 'src/**/*.scenario.js', '!src/**/*.page.js' ],
  ...
  vendor_files: {
    js: [
      ...
      'vendor/angular-ui-utils/angular-ui-utils.js',
      'vendor/angular-ui-router/release/angular-ui-router.js',
